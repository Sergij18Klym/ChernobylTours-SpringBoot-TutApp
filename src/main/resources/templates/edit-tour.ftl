...
<div class="container-post">
    <div class="container">
        <form class="forma" name="form-main" method="POST">
            <div class="general-title">Tour Data Form</div>
            <ul class="form-content">
                <li>
                    <h3 style="text-align: center;"><i>Update tour configuration</i>:</h3>
                    <ul class="field-input">
                        <li>
                            <h2>idTour<span class="obl-star"> *</span></h2>
<@spring.formInput path="toursForm.id" fieldType="text"
attributes="class='form-input' name='id' required placeholder='ID' min='7' maxlength='7' "/>
                        </li>
                        <li>
                            <h2>Tour Type<span class="obl-star"> *</span></h2>
<@spring.formInput path="toursForm.tourTyp" fieldType="text"
attributes="class='form-input' name='tourTyp' required placeholder='TT' min='7' maxlength='7' "/>
                        </li>
                        <li>
                            <h2>Tour Start Date<span class="obl-star"> *</span></h2>
<@spring.formInput path="participantsForm.startDate" fieldType="input"
attributes="class='form-input' name='startDate' required placeholder='2020-06-01' maxlength='10' min='10'"/>
                        </li>

                    </ul>
                    <div class="button-field">
                        <input type="submit" name="submit" id="submit" value="Update Tour Data">
