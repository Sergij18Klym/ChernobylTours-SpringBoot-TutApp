...
<div class="container-post">
    <div class="container">
        <div class="forma">
            <div class="general-title">Participant List</div>
            <ul class="form-content">
<table >
    <tr style="border-bottom: 1px solid #EBEBE3; white-space: nowrap; ">
        <th>Name</th>
        <th>Email</th>
        <th>Phone</th>
        <th>Passport</th>
    ...
    <#list modelList as item>
        <tr>
            ...
            <td style="padding: 15px 5px 0;">
                <a href="http://localhost:8085/participants/delete/${item.id}">
                    <span id="trash" class="fa fa-trash"></span>
                </a>
            </td>
            <td style="padding: 15px 5px 0;">
                <a href="http://localhost:8085/participants/edit/${item.id}">
...
<br>
                <a href="http://localhost:8085/create-participant">
