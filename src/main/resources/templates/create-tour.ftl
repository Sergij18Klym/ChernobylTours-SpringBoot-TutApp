    ...
    <div class="container">
        <form class="forma" name="form-main" method="POST">
            ...
            <ul class="form-content">
                <li>
                    <h3 style="text-align: center;"><i>Configure new tour</i>:</h3>
...
attributes="class='form-input' name='id' required placeholder='ID' min='7' maxlength='7' "/>
                        ...
                        <li>
                            ...
                            <select class="form-input" name="tourTyp" required>
                                <option selected value="one-day">1-Day</option>
...
attributes="class='form-input' name='startDate' required placeholder='2020-06-01' maxlength='10' min='10'"/>
                    ...
                    <div class="button-field">
                        <input type="submit" name="submit" id="submit" value="Save Tour Data">
