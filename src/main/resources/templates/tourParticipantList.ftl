...
<head>
    ...
    <title>Tour Participant List</title>
...
<div class="container-post">
    <div class="container">
        <div class="forma">
            <div class="general-title">Tour Participant List</div>
                    ...
                    <table>
                        ...
                        <#list modelList as item>
                            <tr>
                                ...
                                <td>${item.tour.id}</td>
                                <td>${item.cost}</td>
                                <td>${item.permission?c}</td>
                                <td style="padding: 15px 5px 0;">
<a href="http://localhost:8085/tourparticipants/delete/${item.id}">
    <span id="trash" class="fa fa-trash"></span>
</a>
                                </td>
                                <td style="padding: 15px 5px 0;">
<a href="http://localhost:8085/tourparticipants/edit/${item.id}">
    <span id="edit" class="fa fa-pencil"></span>
                ...
                <br>
                <a href="http://localhost:8085/create-tourparticipant">
